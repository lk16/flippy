...
type ClientStats struct {
	...
	Position          othello.NormalizedPosition `json:"position"`
}
...
type Evaluation struct {
	Position   othello.NormalizedPosition `json:"position"   db:"position"`
...
type LookupPositionsPayload struct {
	Positions []othello.NormalizedPosition `json:"positions"`
}
...
// Incoming is an incoming websocket message.
...
// Outgoing is an outgoing websocket message.
type Outgoing struct {
	ID   int `json:"id"`
	Data any `json:"data"`
}

// EvaluationRequest is a websocket request for evaluations.
type EvaluationRequest struct {
	Positions []othello.NormalizedPosition `json:"positions"`
}

// EvaluationResponse is a websocket response with evaluations.
